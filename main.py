...
video=cv2.VideoCapture(0) # khoi tao khung hinh video

with mp_hand.Hands(min_detection_confidence=0.5,
               min_tracking_confidence=0.5) as hands: # do tin cay phat hien toi thieu va do theo doi toi thieu - 50% ~ 0.5
    while True:
        keyPressed = False
        break_pressed=False
        ...
        image=cv2.cvtColor(image, cv2.COLOR_BGR2RGB) # chuyen doi khung hinh sang RGB
        ...
        if len(lmList)!=0:
            ...
            if total==0:
                cv2.rectangle(image, (20, 300), (270, 425), (220,20,60), cv2.FILLED)
